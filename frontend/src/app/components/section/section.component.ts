...
export class SectionComponent implements OnInit {
  ...
  sections:Array<Section> = [
    ...
    {id: "sfsdf32wrwew334",  name: "تأسيس شركة في تركيا",  seoName: "تأسيس شركة في تركيا",  description: "أسيس شركة في تركيا",  articleCount: 30,  image: "./assets/images/4441.jpg",  content: "<h1>dsfsf</h1><strong>sdasd asdasd asd</strong>"},
